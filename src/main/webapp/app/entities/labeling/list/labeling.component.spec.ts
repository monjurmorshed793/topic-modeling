...
describe('Component Tests', () => {
  describe('Labeling Management Component', () => {
    let comp: LabelingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LabelingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.labelings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
